...
class Instant extends React.Component {
  componentDidMount() {
    let source =
      this.props.source != undefined && relays[this.props.source] != undefined
        ? relays[this.props.source]
        : relays['radar']

    let renderJson
    if (
      this.props.feeAddress != undefined &&
      this.props.fee != undefined &&
      parseFloat(this.props.fee) <= 0.05 &&
      parseFloat(this.props.fee) > 0
    ) {
      renderJson = {
        orderSource: source,
        affiliateInfo: {
